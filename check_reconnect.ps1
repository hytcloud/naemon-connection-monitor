...
# 判斷是否有變動（數量不同或內容不同）
$changed = ($currentEndpoints.Count -ne $previousEndpoints.Count) -or ($currentEndpoints | Where-Object { $previousEndpoints -notcontains $_ }).Count -gt 0
